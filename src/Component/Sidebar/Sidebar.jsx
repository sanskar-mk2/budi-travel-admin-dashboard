...
export const ChildSubAgent = React.memo(({ props }) => {
  ...
  return (
    <React.Fragment>
      <div className={`my-[10px] agent grid grid-cols-3 gap-2 place-items-center  transition-opacity hover:bg-primary-color ${location === props?.link && 'text-white bg-primary-color activeClass'} bg-white px-0  py-1 rounded-md`}>
